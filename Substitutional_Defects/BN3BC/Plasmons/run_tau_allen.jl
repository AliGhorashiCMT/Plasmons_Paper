...
force_matrix, cellph_map = phonon_force_matrix("../../BN3BC_Buckled/phonon");
Pwannier = pwannier("wannierUp");

tau_allen =  JJDFTX.τ_allen(HwannierUp, cellmapUp, Pwannier, force_matrix, cellph_map, Heph, celleph_map, collect(0.01:0.01:1), -2.088258123, Val(2); 
mesh=6, supplydos=0.7525, num_blocks=50, fracroom=1, histogram_width=10)
